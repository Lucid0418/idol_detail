...
// stage content:
(lib.sign_effect_2411101 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_2411101_1();

	// image_replace
	this.instance = new lib.replace_image_2411101();
...
// symbols:
(lib.replace_image_2411101 = function() {
	this.initialize(img.replace_image_2411101);
...
(lib.sign_effect_2411101_1 = function() {
	this.initialize();
