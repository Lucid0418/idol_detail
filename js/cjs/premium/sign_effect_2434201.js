...
// stage content:
(lib.sign_effect_2434201 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_2434201_1();

	// image_replace
	this.instance = new lib.replace_image_2434201();

	this.addChild(this.instance,this.sign_effect);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,685.4,800);


// symbols:
(lib.replace_image_2434201 = function() {
	this.initialize(img.replace_image_2434201);
...
(lib.reflect_container_cjs_2434201 = function(mode,startPosition,loop) {
...
(lib.reflect_wrapper_2434201 = function() {
	this.initialize();

	// cjs
	this.reflect = new lib.reflect_container_cjs_2434201();
...
(lib.sign_effect_2434201_1 = function() {
	this.initialize();

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.setTransform(473.5,579.5);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.setTransform(629.3,496.8);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.setTransform(406.6,476.3);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.setTransform(477.4,494.4,0.725,0.725);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.setTransform(556.9,448.8,0.692,0.692);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.setTransform(396.5,575.9,0.66,0.66);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.setTransform(305.9,629.7);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.setTransform(579.2,562.3);

	// mask
	this.reflect_mask = new lib.reflect_mask_2434201();
	this.reflect_mask.setTransform(466.9,527.6);
	this.reflect_mask.alpha = 0;

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(318,317.2);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_2434201();
	this.reflect_wrapper.setTransform(297.8,527.6);
...
p.nominalBounds = new cjs.Rectangle(249.8,106.1,435.6,843);
